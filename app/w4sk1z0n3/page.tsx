  ...
  return (
    <main className="scanline min-h-screen bg-ink text-white">
      <section className="mx-auto max-w-7xl px-5 py-12 lg:px-8">
        <SourceBackLink fallback={{ href: "https://waskizone.com", label: "Back to WaskiZone" }} sources={{ cybersecurity: { href: "https://waskizone.com/cybersecurity", label: "Back to security services" } }} />
