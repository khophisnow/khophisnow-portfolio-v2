  ...
  return (
    <main className="scanline min-h-screen bg-ink text-white">
      ...
      <section className="relative z-10 mx-auto grid max-w-7xl gap-10 px-5 py-14 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:px-8 lg:py-24">
        ...
        <div className="grid gap-4">
          <figure className="grid overflow-hidden border border-white/10 bg-panel/78 p-4 shadow-terminal md:grid-cols-[0.86fr_1.14fr]">
            <div className="relative flex min-h-[220px] items-center justify-center overflow-hidden p-3 sm:min-h-[320px] sm:p-5">
              ...
              <Image src="/brand/waskizone/icon/mark.png" alt="WaskiZone shield mark" width={1254} height={1254} priority className="relative max-h-[230px] w-full object-contain sm:max-h-[360px]" />
            </div>
            <div className="flex flex-col justify-center border-t border-white/10 p-4 sm:p-5 md:border-l md:border-t-0">
          ...
          <div className="border border-mint/25 bg-mint/10 p-4 sm:p-5">
      ...
      <section className="border-y border-white/10 bg-ink/72">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] lg:px-8">
