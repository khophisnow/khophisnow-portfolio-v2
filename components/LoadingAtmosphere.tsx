...
export function LoadingAtmosphere({ eyebrow, title, autoDismiss = false, showSkip = false, duration = 5200 }: LoadingAtmosphereProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] overflow-hidden bg-ink bg-cover bg-center text-white"
    ...
    >
      ...
      <div className="relative flex min-h-screen flex-col justify-end gap-4 p-4 sm:flex-row sm:items-end sm:justify-between sm:p-8">
