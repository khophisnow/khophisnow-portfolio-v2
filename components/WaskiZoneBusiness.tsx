    ...
    <section id="packages" className="border-y border-white/10 bg-white/[0.025]">
      <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
          ...
          <a href="https://waskizone.com/contact" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-mint px-4 py-3 font-bold text-ink hover:bg-white">Request proposal<ArrowUpRight size={16} /></a>
        </div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
      <div className="grid gap-10 lg:grid-cols-[0.38fr_0.62fr]">
        <div><SectionTitle eyebrow="Authorized security only" title="Professional boundaries for cybersecurity work" /><p className="mt-5 text-sm leading-7 text-white/62">Security work under WaskiZone/W4sk1Z0n3 is scoped, authorized, documented, and defensive.</p><a href="https://waskizone.com/policy/authorized-security" target="_blank" rel="noopener noreferrer" className="mt-7 inline-flex items-center gap-2 border border-mint/30 px-4 py-3 font-bold text-mint hover:bg-mint hover:text-ink">Read policy<ArrowUpRight size={16} /></a></div>
